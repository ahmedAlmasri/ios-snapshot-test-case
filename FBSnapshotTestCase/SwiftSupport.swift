...
public extension FBSnapshotTestCase {
    ...
    @available(iOS 13, *)
    func FBSnapshotVerifyViewControllerForLightDarkMode(_ navigationController: UINavigationController, window: UIWindow, identifier: String? = nil, delay: TimeInterval = 0, perPixelTolerance: CGFloat = 0, overallTolerance: CGFloat = 0, file: StaticString = #file, line: UInt = #line) {
    ...
    func FBSnapshotVerifyViewControllerForLightDarkMode(_ viewController: UIViewController, identifier: String? = nil, delay: TimeInterval = 0, perPixelTolerance: CGFloat = 0, overallTolerance: CGFloat = 0, file: StaticString = #file, line: UInt = #line) {
        ...
        FBSnapshotVerifyViewControllerForLightDarkMode(navigationController, window: window, identifier: identifier, delay: delay, perPixelTolerance: perPixelTolerance, overallTolerance: overallTolerance)
    }
